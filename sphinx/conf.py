...
breathe_projects = {"limef": "../doxygen/xml"}
breathe_default_project = "limef"

# MyST parser configuration
# Required: pip3 install linkify-it-py  (for linkify extension)
myst_enable_extensions = [
    "colon_fence",      # ::: directives
    "deflist",          # definition lists
    "fieldlist",        # field lists
    "html_admonition",  # admonitions via HTML syntax
    "html_image",       # images via HTML syntax
...
project = 'Media Streaming Framework for Linux' # a better name
...
html_theme="furo" # you might need to install with pip3
...
man_pages = [
  (master_doc, '', ' Documentation',[author], 1)
]
...
#     author, '', 'Empty python project template',
#     'Miscellaneous'),
#]
